...
export default function DestinationsPageClient({ destinations, allDestinations }: DestinationsPageClientProps) {
  ...
  return (
    <>
      {/* Row 1: Map (8 cols) + All Destinations List (4 cols) */}
      ...
      <div className="col-span-12 xl:col-span-4 bg-surface-container-lowest border border-surface-variant rounded-xl shadow-[0px_4px_12px_rgba(15,23,42,0.03)] flex flex-col h-[500px]">
        <div className="p-widget-padding border-b border-surface-container">
          <div className="flex justify-between items-center">
            <div>
              <h3 className="text-headline-sm font-headline-sm text-on-surface">Total Destinations</h3>
        ...
        <div className="p-widget-padding flex-1 flex flex-col gap-4 overflow-y-auto">
          {sortedAll.map((d) => {
              ...
              >
                <div className="flex justify-between items-end mb-2">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <span className="text-body-sm font-body-sm font-medium text-on-surface block">{d.city} ({d.code})</span>
